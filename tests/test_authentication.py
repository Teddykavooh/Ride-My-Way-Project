...
class Authentication(ConfigTestCase):
    ...
    def test_invalid_token(self):
        ...
        driver_header = {"Content-Type": "application/json", "x-access-token": "brabrabrastakikuskia"}
        response_d = self.client().post('/api/v2/rides', data=json.dumps(ride), content_type='application/json',
